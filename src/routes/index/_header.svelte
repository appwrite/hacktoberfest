...
<div class="hidden md:block fixed top-0 z-30 shadow-md w-full">
	<div class="relative flex items-center justify-center space-x-[136px] py-[26px] bg-neutral-200">
		{#each sections as section}
			<button
				...
				section.id
					? 'text-primary'
					: 'text-current-color'}">{section.name}</button
			>
		{/each}
...
<div class="relative z-40 bg-neutral-200">
	<header class="z-50 left-0 top-0 w-full p-[24px] border-b-[1px] border-neutral-150">
		<div
